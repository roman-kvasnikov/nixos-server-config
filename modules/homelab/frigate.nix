  ...
  config = lib.mkMerge [
    (lib.mkIf cfg.enable {
      ...
      systemd.tmpfiles.rules = [
        ...
        "d ${cfg.dataDir}/recordings 0750 frigate ${cfgServer.systemGroup} - -"
        "d ${cfg.dataDir}/clips 0750 frigate ${cfgServer.systemGroup} - -"
        "d ${cfg.dataDir}/snapshots 0750 frigate ${cfgServer.systemGroup} - -"
        "d ${cfg.dataDir}/exports 0750 frigate ${cfgServer.systemGroup} - -"
        "d ${cfg.dataDir}/db 0750 frigate ${cfgServer.systemGroup} - -"
      ];
